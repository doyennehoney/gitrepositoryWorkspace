...
//		}			
	...
	public void deltaInt() {
		...
		if(!grid.getDataGrid().equals(null)){
			...
			for(int i = 0; i<grid.getDataGrid().size(); i++) {
				for(int j = 0; j<grid.getDataGrid().get(i).getItem().size(); j++) {
					old_pop = grid.getDataGrid().get(i).getItem().get(j).getSize();
					grid.getDataGrid().get(i).getItem().get(j).setSize(old_pop*Math.exp(time * 0.25928853/365));				}
			}
		}	
		...
		if(!grid.getDataGrid().equals(null)){
			...
			for(int i = 0; i<grid.getDataGrid().size(); i++) {
				for(int j = 0; j<grid.getDataGrid().get(i).getItem().size(); j++) {
					...
					trajectory.println(t+ ","+i + ""+j+","  + grid.getDataGrid().get(i).getItem().get(j).getSize()+","+grid.getDataGrid().get(i).getItem().get(j).getSusceptible()+","+grid.getDataGrid().get(i).getItem().get(j).getInfected()+","+grid.getDataGrid().get(i).getItem().get(j).getRecovered()); 
				}
			}
			t++;
		}
