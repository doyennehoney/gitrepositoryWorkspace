...
public class Test_coupled extends CoupledModel {
	...
	public Test_coupled(String name, String desc, int x, int y) {
		...
		/**
		 * Commented out the line above (addEIC) because Demography no longer receives from Epidemiology
		 * rather
		 * 1. Demography sends to Epidemiology
		 * 2. Demography sends to Viewer to collation (Yet to indicate this coupling)
		 */
	}
